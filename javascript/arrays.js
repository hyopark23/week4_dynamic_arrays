...
{
  //we only want the src attribute of the image so we need to ge the "src" attribute of the image tag we click on...
  ...
  //get the element you clikced on OUT of the imageListA array and save the clicked image path to a variable so we can use it later
  var selectedImage = imageListA.splice(imageIndex, 1);
  //console.log(selectedImage);
  
  //add this image path to the purchasedImage array..
  purchasedImages.push(selectedImage);//push adds the element to the newe array
...
function update_shopping_cart()
{
  ...
  //evt.target.setAttribute("src", "images/drawing/thumbs/artwork_21.jpg");
